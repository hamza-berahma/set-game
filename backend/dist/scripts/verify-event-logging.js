...
async function verifyEventLogging() {
    ...
    try {
        ...
        const result = await database_1.default.query(`SELECT * FROM game_event_log WHERE room_id = $1 ORDER BY created_at DESC LIMIT 1`, [testRoomId]);
    ...
    // Clean up test event
    try {
        await database_1.default.query(`DELETE FROM game_event_log WHERE room_id = $1`, [testRoomId]);
