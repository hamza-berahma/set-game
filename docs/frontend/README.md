...
graph TB
    ...
    class App frontend
    class Welcome,Login,Register,Lobby,GameRoom page
    class Card,GameBoard,Modal,Toast,PublicGames component
    class API,Socket service
...
sequenceDiagram
    ...
    Note over User,Backend: Authentication Data Flow
```
